...
const Industries = () => {
  ...
  return (
    <section id="industries" className="py-20 bg-transparent scroll-mt-20" style={calibriStyle}>
      <div className="max-w-[1600px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {industryList.map((industry, index) => (
            <div 
              key={index} 
              className="group relative h-[450px] rounded-[3rem] overflow-hidden shadow-2xl transition-all duration-700 hover:-translate-y-4"
            >
              ...
              {/* UPDATED: justify-end changed to justify-center and items-center added for center alignment */}
